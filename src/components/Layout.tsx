      ...
      <header className="flex-shrink-0 bg-surface-page border-b border-surface-border safe-top z-40">
        <div className="flex items-center justify-between px-4 py-2">
          ...
          <div className="flex items-center gap-2">
            ...
            {!showBack && user?.phone_number === '03485157554' && (
              <button
                onClick={() => router.push('/settings')}
                className="min-w-[44px] min-h-[44px] flex items-center justify-center text-ink-secondary hover:text-ink transition-colors"
                title="Settings"
                aria-label="Settings"
              >
